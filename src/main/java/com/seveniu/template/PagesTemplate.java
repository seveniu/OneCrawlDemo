...
public class PagesTemplate {
    ...
    public static PagesTemplate fromOldJson(int id, String json) {
        PagesTemplate pagesTemplate = new PagesTemplate();
        try {
