                    ...
                    <div class="portlet-body">
                        <form id="fieldForm" action="">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" maxlength="50" name="fields" />
                                <span for="fields" class="help-block"></span>
                            </div>
                        </form>
                    </div>
                </div>
...
<script type="text/javascript">
    ...
    pagurian.call("modules/datatable/app", function (app) {
        pagurian.path.api = "/api/field-group";
